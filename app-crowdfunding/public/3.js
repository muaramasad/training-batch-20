...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios.get('/api/campaigns/random/2').then(function (response) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "v-card",
        { attrs: { to: "/campaigns/" + _vm.campaign.id } },
        [
          _c(
            "v-img",
            {
            ...
            [
              ...
              _c("span", [
                _vm._v(
                  "Rp " +
                    _vm._s(
                      _vm.campaign.donation_required.toLocaleString("id-ID")
                    )
                )
              ]),
              _vm._v(" "),
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "v-container",
        { staticClass: "pa-0", attrs: { "grid-list-sm": "" } },
        [
          _c(
            "div",
          ...
          _c(
            ...
            _vm._l(_vm.campaigns, function(campaign, index) {
              return _c(
                "v-flex",
                { key: "campaigns-" + campaign.id, attrs: { xs6: "" } },
